...
from src.ch3.kraft_mcmillan import (eval_kraft_mcmillan,
                                    eval_kraft_mcmillan_len,
                                    eval_kraft_mcmillan_min_len,
...
def test_kraft_mcmillan_len():
    assert eval_kraft_mcmillan_len(Fraction(63, 64), 2, 1, 2, 4, 5, 6) == 3
    assert eval_kraft_mcmillan_len(Fraction(7, 8), 2, 2, 2, 3, 4, 4) == 3


def test_kraft_mcmillan_min_len():
    assert eval_kraft_mcmillan_min_len(2, 1, 2, 3, 4, 5, 7) == 6
    assert eval_kraft_mcmillan_min_len(2, 1, 2, 3, 4, 6, 6) == 5
